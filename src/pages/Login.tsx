  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-xl shadow-lg text-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">MicaLingo</h1>
          <h2 className="mt-4 text-2xl font-bold text-gray-800">{t('login_page_title')}</h2>
          <p className="mt-2 text-gray-600">{t('login_page_subtitle')}</p>
        </div>
        <button
