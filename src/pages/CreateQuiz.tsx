      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto space-y-8 px-4 md:px-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-lg text-blue-900/70 font-medium mt-1">{t('create_your_own_quizzes_subtitle_loggedin')}</p>
          </div>
        </div>
        ...
        <div className="bg-white/60 backdrop-blur-xl p-6 md:p-8 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white space-y-6">
          <h2 className="text-2xl font-extrabold text-blue-950">{t('choose_data_source')}</h2>
          
          <div className="grid gap-6 md:grid-cols-2 mt-4">
            <div className="group relative flex flex-col items-start p-6 md:p-8 rounded-[2rem] bg-white/90 backdrop-blur-xl border border-blue-50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(37,99,235,0.15)] hover:border-blue-200 hover:-translate-y-2 transition-all duration-500 cursor-pointer">
              <h3 className="font-extrabold text-gray-900 group-hover:text-blue-700 transition-colors text-xl mb-1">{t('use_personal_library')}</h3>
              <p className="text-gray-600 font-medium text-sm">{t('use_personal_library_desc')}</p>
            </div>
            
            <div className="group relative flex flex-col items-start p-6 md:p-8 rounded-[2rem] bg-white/90 backdrop-blur-xl border border-blue-50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(37,99,235,0.15)] hover:border-blue-200 hover:-translate-y-2 transition-all duration-500 cursor-pointer">
              <h3 className="font-extrabold text-gray-900 group-hover:text-blue-700 transition-colors text-xl mb-1">{t('upload_new_file')}</h3>
              <p className="text-gray-600 font-medium text-sm">{t('upload_new_file_desc')}</p>
            </div>
          </div>
        </div>
      </div>
