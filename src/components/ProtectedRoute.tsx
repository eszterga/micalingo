      ...
      <div className="flex flex-col items-center justify-center min-h-[70vh] p-4">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 max-w-md text-center">
          <div className="mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Personalized Space</h2>
            <p className="text-gray-600 mt-3 text-sm leading-relaxed">
              To keep MicaLingo personalized with your own vocabulary, exercises, and progress, modifying the database requires an account.
              <br/><br/>
